...
const fn = async function (
  ...
  const metricList = await onlyMetrics(
    modelData,
    metricData,
    partyId,
    role,
  ...
  const cluData = modelData.data.data
    ? modelData.data.data.clusterDetail
    : null;
  const cenData = modelData.data.data
    ? modelData.data.data.centroidDetail
    : null;
        ...
        options: [
          {
            ...
            props: {
              content:
                'count of clusters: ' + modelData.data.data.countOfClusters,
