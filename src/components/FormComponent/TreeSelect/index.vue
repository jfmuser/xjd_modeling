  ...
  <div class="cus-tree__container">
    <header class="cus-tree__header">
      ...
      <div class="cus-tree__header-right">
        <div v-show="isTreeBtnLikeLine" class="cus-tree__gradient">
          ...
          <span
            :style="{
              background: `linear-gradient(to right,${currentColor}, ${currentColor.replace(
                ',1)',
                ',0.2)',
              )})`,
            }"
        ...
        <icon-hover-and-active
          ...
          :default-url="
            isTreeBtnLikeLine
              ? icons.normal['tree-line']
              : icons.normal['tree-spectrum']
          "
          :hover-url="
            isTreeBtnLikeLine
              ? icons.hover['tree-line']
              : icons.hover['tree-spectrum']
          "
          :active-url="
            isTreeBtnLikeLine
              ? icons.hover['tree-line']
    ...
    <footer class="cus-tree__footer">
      ...
      <c-text
        ...
        :data="{
          '{size}': (param) => {
            return param.size ? param.size : 'unkonw';
          },
        }"
        class="cus-tree__text"
      />
...
import CTitle from '../Text/Title/index.vue';
import CSelect from '../Select/index.vue';
import CSearch from '../Searching/index.vue';
import CTreeSelect from './TabList.vue';
import iconHoverAndActive from '@/components/IconHoverAndActive/index.vue';
import CChart from '../../ChartComponent/EchartsInstance/index.vue';
import CText from '../Text/index.vue';
