  ...
  <div class="filter__container">
    ...
    <div v-show="selectionDialog" class="dialog__container">
      <header class="dialog__header">
        <el-icon @click.stop="cancelFilter"><close /></el-icon>
      </header>
      <main class="dialog__main">
        <div class="checkbox__container">
          <header>
            <e-title :content="'Cluster label'" />
            <span class="dialog__link" @click.stop="selectAllCluster"
              >select all</span
            >
          </header>
          <main>
        ...
        <div class="checkbox__container">
          <header>
            ...
            <span class="dialog__link" @click.stop="SelectAllTrue"
              >select all</span
            >
          </header>
          <main>
...
import eTitle from '../Text/Title/index.vue';
export default {
  name: 'TableSelection',
