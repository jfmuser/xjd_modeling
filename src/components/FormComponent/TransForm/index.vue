    ...
    <div v-show="dialogShowing" class="transform__dialog">
      <header class="transform__header">
        <slot name="header">
          ...
          <el-icon class="transform__icon" @click.stop="closeDialog">
            <close />
          </el-icon>
        </slot>
      </header>
        ...
        <div class="transform__list">
          <span class="transform__list-header">
            <div class="transform__header-op">
              ...
              <el-link class="transform__header-link" @click.stop="selectAll"
                >select all</el-link
              >
            </div>
          </span>
          <div class="tranform__list-body">
            <div
              ...
              :key="index"
              class="transform__list-item align-left"
            >
              <el-checkbox v-model="item.checked" class="transform__checkbox" />
              <span
                class="transform__checkbox-label"
        ...
        <div class="transform__list">
          ...
          <div class="tranform__list-body">
            ...
            >
              ...
              <el-icon class="transform__icon" @click.stop="deleteItem(item)">
                <close />
              </el-icon>
            </div>
          </div>
