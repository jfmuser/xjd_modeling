<template>
  <div class="tab_component-container">
    <div
      :class="{ 'front-inrow': inrow, 'front-inrow-left': inrow === 'left' }"
    >
      <slot name="header">
    ...
    <slot :data="content" name="content">
      <div>
        <ComponentGroup
          ...
          :options="item"
          :class="{
            'tab-container_item': true,
            'tab-container_item-show': currentValue === key,
          }"
...
import ctitle from '../FormComponent/Text/Title/index.vue';
