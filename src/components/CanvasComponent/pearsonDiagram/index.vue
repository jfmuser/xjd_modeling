<template>
  <div
    class="flex flex-col space-between correlation-container"
    @click="dialogClose"
  >
    <div class="flex flex-row space-between flex-center correlation-title">
      <div class="flex flex-row flex-center">
        ...
        >
          <div class="flex flex-row flex-end title-filter-title">
            <el-icon @click.stop="showTransferDialog = false">
              <close />
            </el-icon>
          </div>
          <transfer
      ...
      <div class="flex flex-row flex-center correlation-operations">
        ...
        <icon-hover-and-active
          ...
          :default-url="icons.pearsonSortby.default"
          :hover-url="icons.pearsonSortby.hover"
          :active-url="icons.pearsonSortby.active"
        ...
        <icon-hover-and-active
          :class-name="'img-wrapper'"
          :default-url="icons.pearsonFilter.default"
          :hover-url="icons.pearsonFilter.hover"
          :active-url="icons.pearsonFilter.click"
          class="operation-btnicon btn-no-margin"
          @clickFn="showingFilterRange"
        />
        <filter-range
          v-show="showRangefilter"
          ref="filterRange"
          @filter="filterCorrelation"
        />
      </div>
    </div>
    <div
      class="flex flex-row space-around flex-center correlation-relationship"
    >
...
import sortBy from './sorting.vue';
