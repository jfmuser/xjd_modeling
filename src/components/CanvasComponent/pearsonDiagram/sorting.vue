<template>
  <div
    class="flex flex-col justify-center sortby-constainer"
    ...
    <div class="flex flex-row flex-center space-between sort-footer">
      <div class="flex flex-row sort-operation">
        <icon-hover-and-active
          ...
          :default-url="
            require('@/components/CanvasComponent/pearsonDiagram/icons/sortby_up_default.png')
          "
          :hover-url="
            require('@/components/CanvasComponent/pearsonDiagram/icons/sortby_up_hover.png')
          "
          :active-url="
            require('@/components/CanvasComponent/pearsonDiagram/icons/sortby_up_click.png')
          "
          :hold="true"
          :btn-title="'ascending'"
        ...
        <icon-hover-and-active
          ...
          :class-name="'img-wrapper'"
          :default-url="
            require('@/components/CanvasComponent/pearsonDiagram/icons/sortby_down_default.png')
          "
          :hover-url="
            require('@/components/CanvasComponent/pearsonDiagram/icons/sortby_down_hover.png')
          "
          :active-url="
            require('@/components/CanvasComponent/pearsonDiagram/icons/sortby_down_click.png')
          "
          :hold="true"
...
import IconHoverAndActive from '@/components/IconHoverAndActive/index.vue';
export default {
  name: 'FeatureSort',
  components: {
    IconHoverAndActive,
